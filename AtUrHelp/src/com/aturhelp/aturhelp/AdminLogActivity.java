...
public class AdminLogActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ringProgressDialog = ProgressDialog.show(AdminLogActivity.this, Constants.PLEASE_WAIT,	Constants.WORKING_ON_IT, true);
	...
	private class ServerPro extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			String logInfoURL = AtUrHelpUtils.getLogInfo(deviceId);
	...
	public void setList(String result) {
		try {
			if (result != null && !result.equals("")) {
				...
				lView.setAdapter(new AdminListAdapter(this, complaintArray, complaintObject));
				ringProgressDialog.dismiss();
			} else {
				ringProgressDialog.dismiss();
